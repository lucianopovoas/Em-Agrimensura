        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {differentials.map((differential, index) => (
              ...
              >
                <div className="group bg-[#FFFFFF]/10 backdrop-blur-sm rounded-xl p-6 hover:bg-[#FFFFFF]/20 transition-all duration-300 border border-[#68FFFF]/20 h-full flex flex-col min-h-[320px]">
                  {/* Icon */}
                  ...
                  <p className="text-[#FFFFFF]/80 leading-relaxed flex-grow">
          ...
          >
            <div className="bg-[#68FFFF]/10 backdrop-blur-sm rounded-2xl p-8 border border-[#68FFFF]/30">
              <h3 className="text-2xl font-bold text-[#FFFFFF] mb-4">
                Experimente a Diferença da EM Agrimensura
              </h3>
              <p className="text-[#FFFFFF]/90 mb-6 max-w-2xl mx-auto">
                Junte-se aos nossos clientes que já experimentaram a excelência
